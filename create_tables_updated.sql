...
-- Este script cria a estrutura das tabelas no banco de dados PostgreSQL.
-- A coluna 'notas' na tabela 'Matricula' foi alterada para NUMERIC(5,2)
-- para permitir cálculos de média de forma mais eficiente e correta.
